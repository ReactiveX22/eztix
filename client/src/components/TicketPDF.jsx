...
const TicketPDF = () => {
  const ticketPDF = {
    customer_phone: '01653987005',
    coach_id: 5,
    departure_time: '2024-10-30T14:13:00.000Z',
    start_location: 'Dhaka',
    end_location: 'Chittagong',
    seats: 'C1, D2, E1, E2, D1, C2, C3, C4, C5, C6',
    seats_fare: '800.00',
    total_fare: '4800.00',
  };
  ...
  return (
    <div>
      <h1 className='mb-6 text-center text-lg font-medium'>eztix</h1>
      <div className='viewerContainer mx-auto w-72'>
        <PDFViewer style={{ width: '100%', height: '600px' }}>
          <TicketPDFDocument ticket={ticketPDF} />
        </PDFViewer>
      </div>
      <div className='mx-auto w-72'>
        <PDFDownloadLink
          document={<TicketPDFDocument ticket={ticketPDF} />}
          fileName='ticket.pdf'
        >
